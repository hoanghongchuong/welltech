	                  		...
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<input type="text" name="txtAlias" id="" value="{{ $data->alias_vi }}"  class="form-control" />
									</div>
	                	...
	                	<div class="tab-pane" id="tab_3">
	                  		<div class="row">
		                    	<div class="col-md-6 col-xs-12">			                    	
							    	...
							    	<div class="form-group">
								      	<label for="ten">Tên</label>
								      	<input type="text" name="name_jp" value="{{$data->name_jp}}"  class="form-control" />
									</div>
	                	...
	                	<div class="tab-pane" id="tab_4">
	                  		<div class="row">
		                    	<div class="col-md-6 col-xs-12">			                    	
							    	...
							    	<div class="form-group">
								      	<label for="ten">Tên</label>
								      	<input type="text" name="name_kr" value="{{$data->name_kr}}"  class="form-control" />
									</div>
	                	...
	                	<div class="tab-pane" id="tab_5">
	                  		<div class="row">
		                    	<div class="col-md-6 col-xs-12">			                    	
							    	...
							    	<div class="form-group">
								      	<label for="ten">Tên</label>
								      	<input type="text" name="name_chn" value="{{$data->name_chn}}"  class="form-control" />
									</div>
