...
<section class="content-header">
	...
	<ol class="breadcrumb">
	    ...
	    <li class="active">Quản lý profile</li>
	</ol>
</section>
			...
			<form action="{{ route('profile') }}" method="post" enctype="multipart/form-data">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" disabled="" name="usernamex" value="{{ old('username', isset($admin) ? $admin->username : '') }}">
					</div>
					<div class="form-group">
						<label for="">Mật khẩu</label>
						<input type="password" class="form-control" name="password" placeholder="{{ old('password', isset($admin) ? '******' : '') }}">
					</div>
					<div class="form-group">
