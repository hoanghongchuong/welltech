                        ...
                        <div class="vk-filter">
                            <div class="vk-filter__item">
                                ...
                                <select name="view" id="" class="form-control form-change">
                                    <option value="8" {{ (isset($view_selected) and $view_selected == 8) ? 'selected' : ''}}>8</option>
                                    <option value="12" {{ (isset($view_selected) and $view_selected == 12) ? 'selected' : ''}}>12</option>
                                    <option value="16" {{ (isset($view_selected) and $view_selected == 16) ? 'selected' : ''}}>16</option>
                                    <option value="20" {{ (isset($view_selected) and $view_selected == 20) ? 'selected' : ''}}>20</option>
                                </select>
